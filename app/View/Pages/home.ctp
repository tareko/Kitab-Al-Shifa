...
<?php
	if ($admin) { ?>
		...
		<ul>
			...
			<li><?php echo $this->Html->link('Scheduled shifts (calendar edit)', array('controller' => 'shifts', 'action' => 'calendarEdit')); ?> - for looking at and editing many entries</li>
			<li><?php echo $this->Html->link('Scheduled shifts (pdf)', array('controller' => 'shifts', 'action' => 'pdfView')); ?> - exported PDFs with options to create/update and view</li>
