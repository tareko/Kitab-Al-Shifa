	<h2><?php echo __('Trades you have requested');?></h2>
...
<?php endforeach; ?>
	...
	<h2><?php echo __('Trades offered to you');?></h2>
		<table cellpadding="0" cellspacing="0">
		<tr>
				<th><?php echo $this->Paginator->sort('Trade.User.name');?></th>
				<th><?php echo $this->Paginator->sort('Shift.date');?></th>
				<th><?php echo $this->Paginator->sort('Shift.shift_id');?></th>
				<th><?php echo $this->Paginator->sort('status');?></th>
				<th class="actions"><?php echo __('Actions');?></th>
		</tr>
	<?php foreach ($test_trades as $trade): ?>
		<tr>
			...
			<td><?php echo h($trade['TradesDetail']['status']); ?>&nbsp;</td>
			<td class="actions">
