<div class="trades index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('trading_with');?></th>
	...
	<tr>
		...
		<td><?php echo h($trade['Trade']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($trade['Trade']['shift_id']); ?>&nbsp;</td>
		<td><?php echo h($trade['Trade']['trading_with']); ?>&nbsp;</td>
		<td><?php echo h($trade['Trade']['sent_to']); ?>&nbsp;</td>
